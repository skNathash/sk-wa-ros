...
const paymentOptions = [
  ...
  { label: "Paylater", value: "PAYLATER", langKey: "paylater" },
  { label: "COD", value: "COD", langKey: "cod" },
...
const orderSubTypeOptions = [
  ...
  { label: "Reserve Orders", value: "RESERVE" },
  { label: "Assisted Orders", value: "ASSISTED" },
  { label: "Quick Checkout Orders", value: "QUICKCHECKOUT" },
];
