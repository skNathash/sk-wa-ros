  ...
  return (
    <div className="tw:space-y-4">
      {data.map((row, idx) => {
        ...
        const transactionDate = row.transactionDate || row.paymentDate;
        const paymentType = row.paymentType || row.statementType;
        const description = row.description || row.notes || "-";
        const closingBalance = row.outstandingAmount ?? row.balanceAfter ?? 0;
                ...
                <div className="tw:px-4 tw:pt-4 tw:pb-3">
                  <div className="tw:flex tw:justify-between tw:items-start">
                    ...
                    <div className="tw:flex tw:flex-col tw:gap-2 tw:items-end">
                      <AppBadge
                        variant={
                          paymentType === "credit" ? "success" : "danger"
                        }
