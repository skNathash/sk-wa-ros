...
const RouteInfoBanner = ({
  ...
  return (
    <div className="tw:bg-white tw:border tw:border-gray-200 tw:rounded-lg tw:p-3 tw:flex tw:flex-col tw:md:flex-row tw:md:items-center tw:justify-between tw:gap-4 tw:mb-4 tw:shadow-sm">
      ...
      <div className="tw:flex tw:flex-wrap tw:items-center tw:gap-4 tw:md:gap-8">
        {routeInfo?.deliveryDate && (
