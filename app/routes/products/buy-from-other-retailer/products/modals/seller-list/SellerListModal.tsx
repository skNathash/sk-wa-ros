                ...
                <div className="tw:px-1 tw:pt-2 tw:flex-1">
                  <div className="tw:flex tw:flex-col tw:gap-3 tw:text-xs">
                    <div className="tw:flex tw:items-start">
                      <div className="tw:w-36 tw:text-muted-foreground">Menu</div>
                    ...
                    <div className="tw:flex tw:items-start">
                      <div className="tw:w-36 tw:text-muted-foreground">Category</div>
                      <div className="tw:flex-1 tw:font-medium tw:text-foreground tw:truncate">
                        {product.category?.name ? (
                          <span
                            role="button"
                    ...
                    <div className="tw:flex tw:items-start">
                      <div className="tw:w-36 tw:text-muted-foreground">Brand</div>
                      <div className="tw:flex-1 tw:font-medium tw:text-foreground tw:truncate">
                        {product.brand?.name ? (
                          <span
                            role="button"
                    ...
                    <div className="tw:flex tw:items-start">
                      <div className="tw:w-36 tw:text-muted-foreground">Deal ID</div>
                      <div className="tw:flex-1 tw:font-medium tw:text-foreground tw:truncate">
                        {product.id || "-"}
                      </div>
                    </div>
