...
import MenuBrowseGrid from "./components/MenuBrowseGrid";
import MenuGrid from "./components/MenuGrid";
import MenuListPanel, { type MenuItem } from "./components/MenuListPanel";
...
const MenusPage = () => {
  ...
  const applyFilter = React.useCallback(async () => {
    ...
    try {
      ...
      // auto-select the first menu so the category/product columns populate
  ...
  return (
    <>
      <AppHeader title="Browse by Menu" showCart={true} />
                ...
                <AppPaneMain className="tw:lg:col-span-12">
                  {isTheme2 ? (
                   ...
                   menu/category/product layout. */
                    ...
                    <div className="browse-grid--menu tw:grid tw:grid-cols-1 tw:md:grid-cols-[20rem_22rem_1fr] tw:md:grid-rows-1 tw:gap-3 tw:h-[calc(100vh-12rem)]">
                      {/* Col 1 — menus (always visible) */}
                      ...
                      {/* Col 2 + 3 — categories of the selected menu and their
                      ...
                      {!isMobile && (
                        <>
                          <CategoryList
                            ...
                            menuName={
                              selectedMenu?._displayName || selectedMenu?.name
                            }
                            distance={distance}
                          ...
                          <Products
                            ...
                            distance={distance}
                            placeholder="Select a menu to view its products"
                          />
                        </>
                      )}
                    </div>
