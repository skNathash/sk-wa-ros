...
interface RetailersDesktopViewProps {
  loading?: boolean;
...
const headers: TableHeaderItem[] = [
  ...
  //   enableSort: false,
  // },
  { label: "Follow-ups", key: "total", width: "90px", enableSort: false },
  {
  ...
  { label: "Overdue", key: "overdue", width: "80px", enableSort: false },
  {
    label: "Last Contact",
    key: "lastLoggedOn",
    width: "140px",
...
// A single status count, right-aligned with tabular figures. When it has a
// target href and a non-zero value it becomes a link into the retailer overview
...
const RetailersDesktopView: React.FC<RetailersDesktopViewProps> = ({
  loading,
  data,
  loadMore,
  loadingMore,
  ...
  if (!loading && data.length === 0) {
    return (
      <NoData
        ...
        description="This employee has no follow-ups matching the current filters."
      />
    );
  }
...
export default RetailersDesktopView;
