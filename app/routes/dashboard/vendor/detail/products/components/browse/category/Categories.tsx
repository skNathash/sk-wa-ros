...
const Categories = ({ vendorId, callback }: Props) => {
  ...
  const totalCount = paginationRef.current.totalRecords || 0;
  ...
  return (
    <AppCard title={`Categories (${totalCount})`} noContentPadding={true}>
