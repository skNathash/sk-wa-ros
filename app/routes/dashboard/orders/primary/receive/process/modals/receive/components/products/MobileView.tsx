...
interface MobileViewProps {
  products: any[];
  onProductAction?: (productId: string, action: string, data?: any) => void;
...
const MobileView: React.FC<MobileViewProps> = ({
  ...
  const handleProductAction = (
    ...
    if (onProductAction) {
      onProductAction(productId, action, data);
    }
  };
                  ...
                  <div className="tw:space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleProductAction(product._id, "updateQty", {
                    ...
                    <div className="tw:space-y-2">
                      <button
                        onClick={() =>
                          handleProductAction(product._id, "receive")
                        }
                      ...
                      <div className="tw:grid tw:grid-cols-2 tw:gap-2">
                        <button
                          onClick={() =>
                            handleProductAction(product._id, "damage")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleProductAction(product._id, "missing")
                          }
