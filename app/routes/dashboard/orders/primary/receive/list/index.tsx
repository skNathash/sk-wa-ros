...
const PrimaryReceiveList = () => {
  ...
  return (
    <>
      <AppHeader title={t("ordersManagement")} showCart={true} />
      <div className="tw:p-4 app-page page-bg">
        <div className="app-container">
          <AppBreadcrumbs data={breadcrumbs} />
          <div className="tw:mt-2 tw:text-sm tw:text-gray-500 tw:mb-4">
            {t("trackB2cB2bSalesPerformance")}
          </div>
          {/* <OrderTabs activeTab="all-orders" className="tw:mb-4" /> */}

          <OrderListTab activeTab="receive-order" className="tw:mb-4" />
...
export default PrimaryReceiveList;
