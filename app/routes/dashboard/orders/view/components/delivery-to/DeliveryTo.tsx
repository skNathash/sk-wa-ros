  ...
  return (
    <>
      <AppCard className="mb-4">
        ...
        <div>
          <div className="tw:text-xs tw:font-semibold tw:text-gray-700 tw:uppercase tw:tracking-wide tw:mb-2 tw:text-blue-700">
          ...
          {(data?.mobile || data?.email) && (
            <div className="tw:flex tw:flex-wrap tw:items-center tw:gap-x-3 tw:gap-y-1 tw:text-xs tw:text-gray-600">
              {data?.mobile && (
        ...
        {data?.customerType === "Retailer" &&
          (data?.franchiseId || data?.type || data?.subType) && (
            <div className="tw:mt-4 tw:pt-3 tw:border-t tw:border-gray-200 tw:flex tw:flex-wrap tw:gap-x-4 tw:gap-y-1">
              {data?.franchiseId && (
              ...
              {(data?.type || data?.subType) && (
                <div className="tw:text-xs tw:text-gray-600">
                  <span className="tw:text-gray-500 tw:font-medium">Type:</span>{" "}
                  <span className="tw:font-semibold tw:text-gray-800">
                    {data.type || "N/A"}
