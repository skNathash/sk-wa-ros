...
const NonMovingProducts = () => {
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error loading more non moving products:", error);
    } finally {
  ...
  const handleFilterChange = (args?: { action: string; data?: any }) => {
    if (args?.action === "brand" || args?.action === "category" || args?.action === "menu") {
...
export default NonMovingProducts;
