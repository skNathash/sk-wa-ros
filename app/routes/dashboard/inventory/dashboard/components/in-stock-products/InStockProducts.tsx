...
const InStockProducts = () => {
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error loading more in stock products:", error);
    } finally {
      setLoadingMore(false);
    }
  }, [loadingMore, hasMoreData, sort, formMethods]);
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      console.error("Error downloading in stock products:", error);
