...
import SortPopover, { type SortValue } from "./components/SortPopover";
...
const BottomDeadStockProducts = () => {
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error loading more dead stock products:", error);
    } finally {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      console.error("Error downloading dead stock products:", error);
    ...
    <>
      ...
      <div className="tw:flex tw:items-center tw:justify-between tw:mb-4">
        ...
        <div className="tw:flex tw:items-center tw:gap-2">
          ...
          <SortPopover sortValue={sort} onSort={setSort} />
...
export default BottomDeadStockProducts;
