...
import ManageDeliveryPersonModal from "~/modals/feature/delivery/manage-delivery-person/ManageDeliveryPersonModal";
  ...
  return (
    <AppCard
      title={
        <div className="tw:flex tw:justify-between tw:items-center tw:flex-1">
          <span>{`Delivery Personnel (${data.length})`}</span>
          <AppButton
            color="primary"
    ...
    >
      ...
      <ManageDeliveryPersonModal
        ...
        deliveryPerson={modalState.data}
      />
    </AppCard>
  );
};
