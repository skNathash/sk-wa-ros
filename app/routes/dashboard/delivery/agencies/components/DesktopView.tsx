...
import { Eye, SlidersHorizontal, Phone } from "lucide-react";
...
const headers = [
  { label: "Agent Details", key: "name", enableSort: false, width: "25%" },
  { label: "Contact", key: "contact", enableSort: false, width: "20%" },
  {
    label: "COD to Handover",
    key: "codToHandover",
    enableSort: false,
    width: "15%",
  },
  { label: "Account Balance", key: "balance", enableSort: false, width: "15%" },
  { label: "Status", key: "status", enableSort: false, width: "10%" },
  { label: "Actions", key: "actions", enableSort: false, width: "15%" },
];
