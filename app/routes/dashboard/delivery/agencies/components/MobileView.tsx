      ...
      {data.map((row) => (
        ...
        >
          ...
          <div className="tw:my-2 tw:space-y-2">
            ...
            <div className="tw:flex tw:justify-between tw:items-center tw:text-sm">
              <span className="tw:text-gray-500">COD to Handover</span>
              <span className="tw:font-medium tw:text-slate-500">
                <Amount value={row.codToHandover} decimalPlaces={2} />
              </span>
            </div>
            <div className="tw:flex tw:justify-between tw:items-center tw:text-sm">
              <span className="tw:text-gray-500">Account Balance</span>
              <span className="tw:font-medium tw:text-slate-500">
