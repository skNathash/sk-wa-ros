...
export interface ByRunnerFilter extends Record<string, any> {
  search: string;
}
 ...
 */
export interface ByRunnerGroup extends Record<string, any> {
  id: string;
  agentName: string;
  agentMobile: string;
...
/** Build the grouped-shipment query — paging plus the tab's search. */
export const prepareParams = (
  filter: ByRunnerFilter,
...
function formatRunnerGroup(group: Record<string, any>): ByRunnerGroup {
  return {
    ...group,
    id: group._id,
