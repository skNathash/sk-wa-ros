...
const Batches = ({ masterData, selectedStockUom }: BatchesProps) => {
  ...
  return (
    <div>
      ...
      {/* Reason for adjustment textarea */}
      <div className="tw:mt-4">
        <AppTextarea
          label={t("reasonForAdjustment")}
          name="reason"
          register={register}
          placeholder={t("enterReasonForStockAdjustment")}
          rows={3}
          className="tw:w-full"
          isRequired={true}
        />
